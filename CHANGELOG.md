...
- **Upgrade migration infrastructure** — Complete safety net for
  ...
  - 6 new upgrade E2E tests (L8–L13) verifying function existence, stream
    table survival, view queryability, event triggers, version consistency,
    and function parity with fresh installs after upgrade.
