...
the latest v0.105.x release, on PostgreSQL 18. Before LC-6 implementation starts,
...
- [x] PostgreSQL major-upgrade coverage includes active stream tables and
      pending deltas
- [x] The checked-in v1.0 support manifest bounds the final matrix to v0.40.0
      through v0.105.x on PostgreSQL 18. Each released version enters the
      supported list only after its migration and E2E path pass
