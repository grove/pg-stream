...
> After the v0.38.0-v0.46.0 hardening arc, the roadmap resumes the deferred
...
v0.37.0 introduced pgVectorMV. v0.38.0-v0.46.0 then deliberately prioritized
...
> **Hard prerequisite:** v0.38.0-v0.46.0 must complete their correctness,
> diagnostics, and operator-trust exit criteria before this embedding work
> starts.

---

*Previous: [v0.46.0 — Operational Readiness, Scalability & CI Completeness](v0.46.0.md)*
*Next: [v0.48.0 — Hybrid Search & Sparse Vector Aggregates](v0.48.0.md)*
