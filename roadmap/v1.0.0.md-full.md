...
After the v0.104.0 feature freeze, v0.105.x accepts only correctness and
security fixes, documentation, tests, compatibility work, packaging,
performance regression fixes, and simplification. It also narrows or removes
unproven optimizer and controller behavior before the release-candidate series.
