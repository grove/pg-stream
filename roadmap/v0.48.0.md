# v0.48.0 — Hybrid Search & Sparse Vector Aggregates
...
v0.47.0 completes embedding pipeline infrastructure; v0.48.0 completes the
...
- Any deferred items from v0.47.0 that did not meet the exit criteria
...
v0.48.0 is a medium release at the upper end. The new test files (tiered
...
*Previous: [v0.47.0 — Embedding Pipeline Infrastructure & ANN Maintenance](v0.47.0.md)*
*Next: [v0.49.0 — Embedding API & Advanced RAG Patterns](v0.49.0.md)*
