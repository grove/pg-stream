# v0.49.0 — Embedding API & Advanced RAG Patterns

> **Full technical details:** [v0.49.0.md-full.md](v0.49.0.md-full.md)
...
v0.41.0-v0.48.0 build the production embedding primitives and hybrid-search
coverage. v0.49.0 consolidates that work into a higher-level ergonomic surface:
...
Today, users still write the full denormalization query by hand. v0.49.0 adds a
...
v0.49.0 is a large release because the ergonomic API hides real query-shape and
...
*Previous: [v0.48.0 — Hybrid Search & Sparse Vector Aggregates](v0.48.0.md)*
