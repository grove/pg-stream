...
**Exit criteria:**
- [ ] A-2: Columnar change tracking bitmask skips irrelevant rows; key column classification ✅, `__pgt_key_changed` annotation ✅; UPDATE-only path reduces delta volume (pending aggregate optimization + benchmark)
